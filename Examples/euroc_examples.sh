#!/bin/bash
pathDatasetEuroc='/home/marc/bags/euroc' #Example, it is necesary to change it by the dataset path
...
./Stereo/stereo_euroc ../Vocabulary/ORBvoc.txt ./Stereo/EuRoC.yaml /home/marc/bags/euroc/MH_01/ ./Stereo/EuRoC_TimeStamps/MH01.txt dataset-MH01_mono
