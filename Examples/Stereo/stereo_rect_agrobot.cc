...
{  
    if(argc < 5)
    {
        cerr << endl << "Usage: ./stereo_rect_agrobot path_to_vocabulary path_to_settings path_to_sequence_folder_1 path_to_times_file_1 (path_to_image_folder_2 path_to_times_file_2 ... path_to_image_folder_N path_to_times_file_N) (trajectory_file_name)" << endl;
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        string pathCam0 = pathSeq + "/cam_left";
        string pathCam1 = pathSeq + "/cam_right";
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        for(int ni=0; ni<nImages[seq]; ni++, proccIm++)
        {
            ...
            if(ttrack<T)
                usleep((T-ttrack)*1e6);
            // Uncomment to freeze on first frame
                ...
                vector<string> &vstrImageRight, vector<double> &vTimestamps)
{
    ...
    string strPrefixLeft = strPathToSequence + "/cam_left/";
    string strPrefixRight = strPathToSequence + "/cam_right/";
